...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            File yourFile = new File("111.big"); //File.createTempFile("your_file_name", null);
    ...
    public static class ClassWithStatic {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            bOS.write(ClassWithStatic.staticString.getBytes());
            bOS.write(";".getBytes());
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            ClassWithStatic.staticString = mem[0];

            this.i = Integer.parseInt(mem[1]);

            this.j = Integer.parseInt(mem[2]);
